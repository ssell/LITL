#ifndef LITL_ENGINE_MATERIAL_PIPELINE_H__
#define LITL_ENGINE_MATERIAL_PIPELINE_H__
...
namespace litl
{
    ...
    public:
        ...
        bool create(Authority<ObjectPool> auth, MaterialPipelineDescriptor const& descriptor, Renderer const& renderer) noexcept;
    ...
    private:
        ...
        MaterialPipelineDescriptor m_descriptor;
