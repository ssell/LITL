...
namespace litl
{
    ...
    public:
        ...
        /// <summary>
        /// Returns the value stored at the specified key if it exists. Otherwise returns the provided default value.
        /// </summary>
        [[nodiscard]] V findOr(K const& key, V defaultValue) noexcept;
