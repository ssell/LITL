...
namespace litl::vulkan
{
    ...
    public:
        ...
        [[nodiscard]] std::optional<StagingBufferIndex> copyIntoStaging(std::span<std::byte const> source, uint64_t sourceOffset, uint64_t sourceSize, uint64_t alignment) noexcept;
