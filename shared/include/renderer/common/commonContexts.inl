#ifndef LITL_COMMON_CONTEXTS_IMPL__
#define LITL_COMMON_CONTEXTS_IMPL__
...
namespace LITL::Renderer
{
    ...
    {
        /// <summary>
        /// The logical device from the RenderContext.
        /// </summary>
        VkDevice device = VK_NULL_HANDLE;
    ...
    struct CommandBufferContext
    {
        ...
        /// <summary>
        /// The pool from which we allocated the command buffer.
        /// </summary>
        VkCommandPool commandPool = VK_NULL_HANDLE;
    ...
    struct MeshContext
    {
        ...
        /// <summary>
        /// The physical device from the RenderContext.
        /// </summary>
        VkPhysicalDevice physicalDevice = VK_NULL_HANDLE;
