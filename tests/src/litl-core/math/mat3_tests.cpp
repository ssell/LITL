...
namespace litl::tests
{
    ...
    LITL_TEST_CASE("mat3 construct from span", "[mat3::construction]")
    {
        ...
        REQUIRE(fequals(m.get(0, 0), 1.0f));
        REQUIRE(fequals(m.get(0, 1), 2.0f));
        REQUIRE(fequals(m.get(0, 2), 3.0f));
        REQUIRE(fequals(m.get(1, 0), 4.0f));
        REQUIRE(fequals(m.get(1, 1), 5.0f));
        REQUIRE(fequals(m.get(1, 2), 6.0f));
    ...
    LITL_TEST_CASE("mat3 construct from partial span pads with zero", "[mat3::construction]")
    {
        ...
        REQUIRE(fequals(m.get(0), 1.0f));
        REQUIRE(fequals(m.get(1), 2.0f));
        REQUIRE(fequals(m.get(2), 3.0f));
        REQUIRE(fequals(m.get(3), 4.0f));
    ...
    LITL_TEST_CASE("mat3 from mat4", "[math::mat4]")
    {
        ...
        REQUIRE(fequals(m3.get(0), 0.0f));
        REQUIRE(fequals(m3.get(1), 1.0f));
        REQUIRE(fequals(m3.get(2), 2.0f));

        REQUIRE(fequals(m3.get(3), 4.0f));
        REQUIRE(fequals(m3.get(4), 5.0f));
        REQUIRE(fequals(m3.get(5), 6.0f));
    ...
    LITL_TEST_CASE("mat3::identity", "[mat3::factory]")
    {
        ...
        REQUIRE(m.isIdentity());
        REQUIRE(fequals(m.get(0, 0), 1.0f));
        REQUIRE(fequals(m.get(1, 1), 1.0f));
    ...
    {
        constexpr float angle = Traits<float>::pi_over_two;
    ...
    LITL_TEST_CASE("mat3 transpose", "[mat3::utility]")
    {
        ...
        REQUIRE(fequals(t.get(0, 0), 1.0f));
        REQUIRE(fequals(t.get(0, 1), 4.0f));
        REQUIRE(fequals(t.get(0, 2), 7.0f));
        REQUIRE(fequals(t.get(1, 0), 2.0f));
        REQUIRE(fequals(t.get(1, 1), 5.0f));
        REQUIRE(fequals(t.get(1, 2), 8.0f));
    ...
    LITL_TEST_CASE("mat3 inverse", "[mat3::utility]")
    {
        ...
        REQUIRE(fequals(inv.get(0, 0), 0.5f));
        REQUIRE(fequals(inv.get(1, 1), 0.25f));
        REQUIRE(fequals(inv.get(2, 2), 0.125f));
    ...
    LITL_TEST_CASE("mat3 absolute", "[mat3::utility]")
    {
        mat3 m{};
