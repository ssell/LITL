...
TEST_CASE("Chunk Layout", "[ecs::chunk]")
{
    ...
    LITL::ECS::ChunkLayout layoutBarFoo;
    LITL::ECS::populateChunkLayout<Bar, Foo>(&layoutBarFoo);
...
TEST_CASE("Header Creation", "[ecs::chunk]")
{
    ...
    LITL::ECS::ChunkLayout layout;
    layout.entityCapacity = capacity;

    LITL::ECS::Chunk chunk0(0, &layout);
    LITL::ECS::Chunk chunk1(1, &layout);
